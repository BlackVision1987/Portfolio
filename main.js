...
function changeLanguage(language) {
  const languageElements = {
    ...
    'about-content': '¡Hola! Soy Gabriel Rioja, un apasionado técnico de PCs y ahora iniciando como desarrollador con experiencia en Python, Django, JavaScript, HTML y CSS. Mi objetivo es el desarrollo y crecimiento personal, transmitir los conocimientos adquiridos.',
  ...
  'en': {
      ...
      'about-content': 'Hello! I am Gabriel Rioja, a passionate PC technician now transitioning into development with experience in Python, Django, JavaScript, HTML, and CSS. My goal is personal development and growth, sharing the knowledge I have acquired.',
